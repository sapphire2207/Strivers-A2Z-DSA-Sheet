...
// Neighbors: 3, 7
// ➤ Adjacent = 3:
// Already visited, is parent → no cycle
// ➤ Adjacent = 7:
// Already visited! But here’s the key:
// Parent = 3, but adjacent = 7 → 7 is not parent of 6
// This means:
// You are at 6
// Visited neighbor 7
// But 7 is not 6’s parent
// ⇒ There’s a back-edge → CYCLE DETECTED 🔁
// Hence:
// if(vis[adjacentNode] && parent != adjacentNode)
//     return true;
// 🟢 Condition holds true → we return true → CYCLE EXISTS ✅